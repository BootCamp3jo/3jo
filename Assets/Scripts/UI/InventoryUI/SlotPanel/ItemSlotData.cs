...
/* [ClassINFO : ItemSlotData]
   @ Description: ItemSlotData게임 오브젝트에 붙어 해당 슬롯에 담긴 아이템의 정보 (itemData 스크립트)를 인벤토리 내에서 담고 있는 역할 (holder).
   @ Attached at : ItemSlot -> ItemSlotData(prefab)
   @ Methods: ============================================
              [public]
              - 추후 작성 예정
              ============================================
...
public class ItemSlotData : MonoBehaviour, IDropHandler
{
    ...
    // Use for InventoryUI.AddItemToEmptySlot() Method ---
